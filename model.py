...
class SentimentClassifier(pl.LightningModule):
    def __init__(self, lr,n_classes, finetune=True):
        super().__init__()
    ...
    def configure_optimizers(self):
        ...
        # scheduler = {'scheduler': torch.optim.lr_scheduler.ExponentialLR(optimizer, gamma=0.9)
        # , 'interval': 'epoch', 'monitor': 'val_loss'}

        return [optimizer]
    
    # def lr_scheduler_step(self,epoch=None, batch=None):
